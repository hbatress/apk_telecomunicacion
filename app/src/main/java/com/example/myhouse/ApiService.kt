...
data class CameraResponse(val ID_Dispositivo: Int, val fecha: String, val hora: String, val NombreDispositivo: String)
...
interface ApiService {
    ...
    suspend fun getCameraResource(@Path("id") deviceId: Int): Response<CameraResponse>
